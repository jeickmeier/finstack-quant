 ...
 * `finstack-py/tests/test_cashflows.py` so the Python and WASM surfaces stay
...
// Same fixture as finstack-py/tests/test_cashflows.py::_cashflow_spec().
...
test('cashflows end-to-end build/validate/flows/accrual from JSON spec', () => {
  ...
  assert.equal(envelope.schema_version, 'finstack.cashflows.schedule/1');
