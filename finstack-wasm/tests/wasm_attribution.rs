...
//!
//! Quant review MO-B4: the attribution execute path previously had no WASM
//! test at all. Covers the full JSON pipeline (attributePnl /
//! attributePnlFromSpec), the schema gate in validateAttributionJson, and the
//! default helpers.
...
use finstack_wasm::api::attribution::*;
...
fn validate_attribution_json_rejects_wrong_schema() {
    let envelope = format!(
        r#"{{"schema":"finstack.attribution/99","spec":{{"instrument":{},"market_t0":{},"market_t1":{},"as_of_t0":"2025-01-15","as_of_t1":"2025-01-16","method":"Parallel"}}}}"#,
        bond_json(),
