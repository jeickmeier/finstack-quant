//! Serde structs for the `finstack.golden/2` fixture schema.
//!
...
pub const SCHEMA_VERSION: &str = "finstack.golden/2";
...
pub struct PricingBody {
    ...
    pub market: Market,
    /// Instrument definition JSON (`finstack.instrument/1` envelope).
