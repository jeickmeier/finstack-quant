...
```rust
use finstack_valuations::models::volatility::{
...
```bash
cargo test -p finstack-valuations -- models::volatility
```

Individual model tests:

```bash
cargo test -p finstack-valuations -- models::volatility::sabr
cargo test -p finstack-valuations -- models::volatility::heston
cargo test -p finstack-valuations -- models::volatility::local_vol
cargo test -p finstack-valuations -- models::volatility::black
cargo test -p finstack-valuations -- models::volatility::normal
```
