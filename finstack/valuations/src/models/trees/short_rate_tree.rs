...
///
/// ```ignore
/// use finstack_valuations::models::trees::short_rate_tree::{
...
impl ShortRateTreeConfig {
    ...
    ///
    /// ```ignore
    /// use finstack_valuations::models::trees::short_rate_tree::ShortRateTreeConfig;
    ///
...
impl ShortRateTree {
    ...
    ///
    /// ```ignore
    /// use finstack_valuations::models::trees::short_rate_tree::ShortRateTree;
    ///
