...
//!
//! ```ignore
//! use finstack_valuations::models::closed_form::greeks::{
...
use crate::models::volatility::black::{d1, d1_d2, d2};
...
///
/// ```ignore
/// use finstack_valuations::models::closed_form::greeks::bs_call_delta;
///
/// let spot = 100.0;
...
///
/// ```ignore
/// use finstack_valuations::models::closed_form::greeks::bs_put_delta;
///
/// let spot = 100.0;
/// let strike = 100.0;    // ATM
/// let time = 1.0;
...
///
/// ```ignore
/// use finstack_valuations::models::closed_form::greeks::bs_gamma;
///
/// let spot = 100.0;
...
///
/// ```ignore
/// use finstack_valuations::models::closed_form::greeks::bs_vega;
///
/// let spot = 100.0;
/// let strike = 100.0;
/// let time = 1.0;
