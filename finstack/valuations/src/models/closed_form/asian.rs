...
//!
//! ```ignore
//! use finstack_valuations::models::closed_form::asian::geometric_asian_call;
//!
//! let spot = 100.0;
//! let strike = 100.0;
//! let time = 1.0;
...
//!
//! ```ignore
//! use finstack_valuations::models::closed_form::asian::arithmetic_asian_put_tw;
//!
//! let spot = 100.0;
//! let strike = 100.0;
...
/// # Errors
///
/// Returns a [`finstack_core::Error::Validation`] when `df` is not a strictly
