...
`InterestRateSwap` can carry `OtcMarginSpec` (`finstack-margin`) for CSA/SIMM-style workflows. See `finstack-margin` docs for SIMM sensitivities and VM/IM metrics.
