 ...
 */
export type D_97801B737Ee7439E285A = "finstack_quant.instrument/1";

/**
 * Canonical single-instrument v1 envelope generated from its serde type.
 */
export interface AgencyCmoWire {
  instrument: D_039F4A0E4D885Fefacb3;
  schema: D_97801B737Ee7439E285A;
}
export interface D_039F4A0E4D885Fefacb3 {
  spec: D_7C91Ed386870962882De;
  type: "agency_cmo";
}
/**
 ...
 */
export interface D_7C91Ed386870962882De {
  /**
   * Agency program
   */
   ...
   */
  collateral?: D_91Fef53F78D7C50653A0 | null;
  /**
  ...
  waterfall: DF7Da310742Dae5C82E98;
}
/**
 ...
 * ```
 */
export interface D_91Fef53F78D7C50653A0 {
  /**
   ...
   */
  last_paid_accrual_end?: Date1 | null;
  maturity: Date2;
 ...
 */
export interface DF7Da310742Dae5C82E98 {
  /**
   ...
   */
  tranches: D_66287E2Bb5Dfa8D61987[];
}
/**
 * CMO tranche definition.
 */
export interface D_66287E2Bb5Dfa8D61987 {
  /**
   ...
   */
  id: string;
  original_face: Money3;
  /**
   * PAC collar (if PAC tranche)
   */
  pac_collar?: DB67A73E0467888Ad8Dcc | null;
  /**
   ...
   * Tranche type
   */
  tranche_type: "sequential" | "pac" | "support" | "interest_only" | "principal_only" | "accrual";
}
/**
 * Current face amount
 */
