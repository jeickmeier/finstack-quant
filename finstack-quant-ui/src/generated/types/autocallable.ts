 ...
 */
export type DCfb39De5C0Da4E8C16F6 = "finstack_quant.instrument/1";

/**
 * Canonical single-instrument v1 envelope generated from its serde type.
 */
export interface AutocallableWire {
  instrument: D_970Ef43Ad46A0C9Bfd73;
  schema: DCfb39De5C0Da4E8C16F6;
}
export interface D_970Ef43Ad46A0C9Bfd73 {
  spec: D_090A2E8Da3E1C2418317;
  type: "autocallable";
}
/**
 * Autocallable structured product instrument.
 */
export interface D_090A2E8Da3E1C2418317 {
