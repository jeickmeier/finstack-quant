 ...
 */
export type D_179Dbc55E68B65B7Ecfc = "finstack_quant.instrument/1";

/**
 * Canonical single-instrument v1 envelope generated from its serde type.
 */
export interface CmsSwapWire {
  instrument: D_5598587674Cd85Bcb9Fb;
  schema: D_179Dbc55E68B65B7Ecfc;
}
export interface D_5598587674Cd85Bcb9Fb {
  spec: D_3Dbd4A1Aab74E98Eef06;
  type: "cms_swap";
}
/**
...
export interface D_3Dbd4A1Aab74E98Eef06 {
   ...
   */
  swap_float_day_count?: DayCount3 | null;
  /**
