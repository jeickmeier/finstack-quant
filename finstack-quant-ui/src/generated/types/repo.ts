 ...
 */
export type DB9E72770F7Ca1Cc0345B = "finstack_quant.instrument/1";

/**
 * Canonical single-instrument v1 envelope generated from its serde type.
 */
export interface RepoWire {
  instrument: DC57D9A07D1506E686Bce;
  schema: DB9E72770F7Ca1Cc0345B;
}
export interface DC57D9A07D1506E686Bce {
  spec: D_911098148B688Bb268Ba;
  type: "repo";
}
/**
 * Repurchase Agreement instrument.
 */
export interface D_911098148B688Bb268Ba {
   ...
   */
  margin_spec?: DDeef56E3A9E2F83Fbb27 | null;
  maturity: Date;
 ...
 */
export interface D_994972192Aa7987F8A64 {
  /**
 ...
 */
export interface DDeef56E3A9E2F83Fbb27 {
  /**
   ...
   */
  eligible_substitutes?: DB32008096Bd7F5Db3Ef6 | null;
  /**
 ...
 * ```
 */
export interface DB32008096Bd7F5Db3Ef6 {
  /**
   ...
   */
  eligible: DC44Cc3F74A1B6D1912Ff[];
  /**
 ...
 */
export interface DC44Cc3F74A1B6D1912Ff {
  /**
   * Asset class
   */
  asset_class:
   ...
   */
  maturity_constraints?: D_769Dd4A1B38991719F61 | null;
  /**
 ...
 */
export interface D_769Dd4A1B38991719F61 {
  /**
