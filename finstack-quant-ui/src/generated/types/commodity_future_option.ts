 ...
 */
export type D_5F17Fe95A4C4B6674579 = "finstack_quant.instrument/1";

/**
 * Canonical single-instrument v1 envelope generated from its serde type.
 */
export interface CommodityFutureOptionWire {
  instrument: D_89De16516A73B5B177Ad;
  schema: D_5F17Fe95A4C4B6674579;
}
export interface D_89De16516A73B5B177Ad {
  spec: DB2F2E22F982588248C19;
  type: "commodity_future_option";
}
/**
 * Exchange-listed option on an arbitrary commodity futures contract.
 */
export interface DB2F2E22F982588248C19 {
 ...
 */
export interface D_76Ad72Eca45160D02157 {
  /**
   ...
   */
  exercise?: D_7F37B1C2B4Eec749Ae48 | null;
  /**
 ...
 */
export interface D_7F37B1C2B4Eec749Ae48 {
  date: Date;
  /**
