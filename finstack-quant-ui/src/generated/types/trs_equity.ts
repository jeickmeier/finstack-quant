 ...
 */
export type DAb4Cbba027968D61Ccae =
  | {
 ...
 */
export type DE550363Bdc80Afec4670 = "finstack_quant.instrument/1";

/**
 * Canonical single-instrument v1 envelope generated from its serde type.
 */
export interface TrsEquityWire {
  instrument: DA04857579E2F6Abbb6Fa;
  schema: DE550363Bdc80Afec4670;
}
export interface DA04857579E2F6Abbb6Fa {
  spec: D_785F04C4Ffd82F89F1Ab;
  type: "trs_equity";
}
/**
 ...
 * ```
 */
export interface D_785F04C4Ffd82F89F1Ab {
   ...
   */
  dividend_settlement: "on_dividend_date" | "at_period_end";
  /**
  ...
  financing: D_4Cb0722B5A138347A415;
  id: Id2;
  /**
   ...
   */
  margin_spec?: D_814830Ab7E82884F46F8 | null;
 ...
 */
export interface D_4Cb0722B5A138347A415 {
  /**
 ...
 * ```
 */
export interface D_814830Ab7E82884F46F8 {
  /**
 ...
 */
export interface DCaf9Af9533Be213246B7 {
  base_currency: Currency;
  /**
   * Contractual business-day calendar for calls and settlements.
   */
  calendar_id: string;
  call_timing: DD57703E0673Eafb40852;
  collateral_curve_id: Id3;
  eligible_collateral: D_034592F0Aa2133Cc6603;
  /**
   ...
   * or trade is cleared).
   */
  im_params?: DBcbfd40D0Be718Fa0B1B | null;
  vm_params: D_5B15Bcb648E98C9285Ec;
}
/**
 * Margin call timing parameters.
 */
export interface DD57703E0673Eafb40852 {
  /**
 ...
 */
export interface D_034592F0Aa2133Cc6603 {
  /**
   ...
   */
  eligible: DCd306119063790Bb5790[];
  /**
 ...
 */
export interface DCd306119063790Bb5790 {
  /**
   * Asset class
   */
  asset_class:
   ...
   */
  maturity_constraints?: D_105Aee679A95F34523Aa | null;
  /**
 ...
 */
export interface D_105Aee679A95F34523Aa {
  /**
 ...
 * ```
 */
export interface DBcbfd40D0Be718Fa0B1B {
  /**
 ...
 */
export interface D_5B15Bcb648E98C9285Ec {
  /**
 ...
 */
export interface D_14A97E9C761228D7D7Fa {
  end: Date1;
 ...
 */
export interface D_3907A55Cf33393B0F707 {
  /**
