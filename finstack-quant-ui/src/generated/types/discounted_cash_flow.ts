 ...
 */
export type DA38745Fab6D6C4B3A533 = "finstack_quant.instrument/1";

/**
 * Canonical single-instrument v1 envelope generated from its serde type.
 */
export interface DiscountedCashFlowWire {
  instrument: DB7951C6B1F5A9B193F7A;
  schema: DA38745Fab6D6C4B3A533;
}
export interface DB7951C6B1F5A9B193F7A {
  spec: D_05Fc0451Dee1E185F517;
 ...
 * plus net debt.
 */
export interface D_05Fc0451Dee1E185F517 {
   ...
   */
  valuation_discounts?: D_24546886B1B30E2280D7 | null;
  /**
 ...
 */
export interface D_0Cec8C79C0F6Ac6E12Ca {
  /**
 ...
 */
export interface D_24546886B1B30E2280D7 {
  /**
