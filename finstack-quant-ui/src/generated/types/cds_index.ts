 ...
 */
export type DA43F3D027De0527C6928 =
  | {
 ...
 */
export type D_015657Ca8Eb5D2Cfb0F1 = "finstack_quant.instrument/1";

/**
 * Canonical single-instrument v1 envelope generated from its serde type.
 */
export interface CdsIndexWire {
  instrument: DC1Fd3B4654F67B71Db17;
...
export interface DBa7B65E7700701Bfc692 {
   ...
   * index name.
   */
  margin_spec?: DFda93E7996D8B702C7E1 | null;
 ...
 */
export interface D_6565F7C25972C77D1Ceb {
  credit_curve_id: Id;
  /**
 ...
 * ```
 */
export interface DFda93E7996D8B702C7E1 {
  /**
 ...
 */
export interface D_256E57436167B610C385 {
  base_currency: Currency;
  /**
   * Contractual business-day calendar for calls and settlements.
   */
  calendar_id: string;
  call_timing: D_2Dbd6A499D1Bbf82155E;
  collateral_curve_id: Id2;
  eligible_collateral: D_7552F10A02B64C1F7149;
  /**
   ...
   * or trade is cleared).
   */
  im_params?: DD753B8F92C808B4Fcb8E | null;
  vm_params: DF0Ed2E93Baffede20Ff4;
}
/**
 * Margin call timing parameters.
 */
export interface D_2Dbd6A499D1Bbf82155E {
  /**
 ...
 */
export interface D_7552F10A02B64C1F7149 {
  /**
   ...
   */
  eligible: DC715F4B1329A743Ff4A3[];
  /**
 ...
 */
export interface DC715F4B1329A743Ff4A3 {
  /**
   * Asset class
   */
  asset_class:
   ...
   */
  maturity_constraints?: DA6A52A2D0Eee1C0D30Ba | null;
  /**
 ...
 */
export interface DA6A52A2D0Eee1C0D30Ba {
  /**
 ...
 * ```
 */
export interface DD753B8F92C808B4Fcb8E {
  /**
 ...
 */
export interface DF0Ed2E93Baffede20Ff4 {
  /**
 ...
 */
export interface D_8E49754Fd6F989211584 {
