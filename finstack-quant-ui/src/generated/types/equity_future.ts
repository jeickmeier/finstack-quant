 ...
 */
export type D_4Cfdcc39D392C1B1D9B7 = "finstack_quant.instrument/1";

/**
 * Canonical single-instrument v1 envelope generated from its serde type.
 */
export interface EquityFutureWire {
  instrument: DEe818961A2F927Efdbd6;
  schema: D_4Cfdcc39D392C1B1D9B7;
}
export interface DEe818961A2F927Efdbd6 {
  spec: D_692Ed7Bfacfc146Cc47B;
  type: "equity_future";
}
/**
 * Exchange-listed future on an equity, equity index, or fixed-currency quanto index.
 */
export interface D_692Ed7Bfacfc146Cc47B {
 ...
 */
export interface D_3D5B799023F59E08E8Fc {
  /**
