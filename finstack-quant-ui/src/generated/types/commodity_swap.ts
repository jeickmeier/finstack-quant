 ...
 */
export type DA871Bd168C45C555Fb6C = "finstack_quant.instrument/1";

/**
 * Canonical single-instrument v1 envelope generated from its serde type.
 */
export interface CommoditySwapWire {
  instrument: D_921Fa1B968E60C3C7Bf0;
  schema: DA871Bd168C45C555Fb6C;
}
export interface D_921Fa1B968E60C3C7Bf0 {
  spec: D_6A0B21D7E4Dfcb5Ae18C;
  type: "commodity_swap";
}
/**
 ...
 * ```
 */
export interface D_6A0B21D7E4Dfcb5Ae18C {
