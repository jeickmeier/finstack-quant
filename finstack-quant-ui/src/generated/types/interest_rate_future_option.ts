 ...
 */
export type D_764872B0Ef048A77B395 = "finstack_quant.instrument/1";

/**
 * Canonical single-instrument v1 envelope generated from its serde type.
 */
export interface InterestRateFutureOptionWire {
  instrument: D_2Dbad0959F654191D513;
  schema: D_764872B0Ef048A77B395;
}
export interface D_2Dbad0959F654191D513 {
  spec: D_490018C80Cb2945Ea7B3;
 ...
 */
export interface D_490018C80Cb2945Ea7B3 {
 ...
 */
export interface D_6052369691731D4521Df {
  /**
   ...
   */
  exercise?: D_1D667A5Df8F118B6E67B | null;
  /**
   ...
   */
  premium_style: "premium_paid" | "futures_style";
  /**
  ...
  settlement:
    ...
    | {
        type: "future";
        underlying_last_trading_date: Date3;
        underlying_settlement_date: Date4;
        /**
 ...
 */
export interface D_1D667A5Df8F118B6E67B {
  date: Date;
  /**
