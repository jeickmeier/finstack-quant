 ...
 */
export type D_40C29976C86Ef72069C6 =
  | "return_of_capital"
  | {
      preferred_irr: {
        /**
 ...
 */
export type DF118D5Ecd284548A969C = "finstack_quant.instrument/1";

/**
 * Canonical single-instrument v1 envelope generated from its serde type.
 */
export interface PrivateMarketsFundWire {
  instrument: DF925983Ba303C45Bee18;
  schema: DF118D5Ecd284548A969C;
}
export interface DF925983Ba303C45Bee18 {
  spec: D_0503A91D85213E009D45;
 ...
 */
export interface D_0503A91D85213E009D45 {
   ...
   */
  unrealized_nav?: Money1 | null;
  waterfall_spec: DB615D613Cb81Bc46Fa6E;
}
/**
 ...
 */
export interface DB76B6B7B3C14106Bbf33 {
  amount: Money;
  date: Date;
  /**
   ...
   * Type of event
   */
  kind: "contribution" | "distribution" | "proceeds";
}
/**
 ...
 */
export interface DB615D613Cb81Bc46Fa6E {
  /**
   * Catch-up mode
   */
   ...
   */
  tranches: D_40C29976C86Ef72069C6[];
}
/**
