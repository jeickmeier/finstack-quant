 ...
 */
export type D_3422Fc770732B0Ea327C =
  | {
      fixed: FixedCouponSpec;
    }
  | {
      floating: DBf3D60B7Aa736F436254;
    }
  | {
      step_up: D_336250C98Cf023A4B5E2;
    }
  | {
      amortizing: {
        base: D_3422Fc770732B0Ea327C;
        /**
 ...
 */
export type DDb531Ffe800Dc24Fde4F = "finstack_quant.instrument/1";

/**
 * Canonical single-instrument v1 envelope generated from its serde type.
 */
export interface BondWire {
  instrument: D_1Eaaadacd5Fba3616C39;
  schema: DDb531Ffe800Dc24Fde4F;
}
export interface D_1Eaaadacd5Fba3616C39 {
  spec: D_67C3F0Fee95F47938Ab4;
  type: "bond";
}
/**
 ...
 */
export interface D_67C3F0Fee95F47938Ab4 {
  /**
   ...
   */
  call_put?: D_5Ac99974B71A6572Dd47 | null;
  /**
   ...
   * and balance path.
   */
  return_floor?: DE19Dd3057Abfdc658580 | null;
 ...
 * ```
 */
export interface D_5Ac99974B71A6572Dd47 {
  /**
   * Call options (issuer can redeem early).
   */
  calls: D_672Fabbbba5B6Aab56Ef[];
  /**
   * Put options (holder can redeem early).
   */
  puts: D_672Fabbbba5B6Aab56Ef[];
}
/**
...
export interface D_672Fabbbba5B6Aab56Ef {
   ...
   */
  make_whole?: D_2A9Dd97D7E94Dadcad76 | null;
  /**
 ...
 */
export interface D_2A9Dd97D7E94Dadcad76 {
 ...
 */
export interface DBf3D60B7Aa736F436254 {
  /**
   * Whether accrual-period boundaries are business-day adjusted with
   * `business_day_convention`.
   *
   ...
   */
  payment_lag_days?: number;
  rate_spec: DAfaff9B4B34177Ac633E;
  /**
   * Roll-date rule for schedule anchors (standard IMM or CDS IMM grids).
   *
   * [`RollRule::None`] (default) keeps plain tenor stepping. The IMM modes
 ...
 */
export interface DAfaff9B4B34177Ac633E {
  /**
 ...
 * ```
 */
export interface D_336250C98Cf023A4B5E2 {
  /**
   * Whether accrual-period boundaries are business-day adjusted with
   * `business_day_convention`.
   *
 ...
 */
export interface D_7C4149870A1F77E1F644 {
  day_count: DayCount4;
  /**
   * Ordered cashflows (coupons, principal payments, fees)
   */
  flows: D_5Fdd6C8Cd626De8799Fe[];
  meta: DFf91F56De5Ec0B73D330;
  notional: DF3215Ce633904F48B76E;
}
/**
 ...
 */
export interface D_5Fdd6C8Cd626De8799Fe {
  /**
   * Optional contractual accrual metadata owned by this flow.
   */
  accrual?: D_931Ca4Fd1B880C77B04D | null;
  /**
 ...
 */
export interface D_931Ca4Fd1B880C77B04D {
  /**
 ...
 */
export interface DFf91F56De5Ec0B73D330 {
  /**
   ...
   */
  projected_fixings?: DC4190F1F5Bda84C722E6[];
  /**
 ...
 */
export interface DF3215Ce633904F48B76E {
  /**
 ...
 * ```
 */
export interface DE19Dd3057Abfdc658580 {
  /**
