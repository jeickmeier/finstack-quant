 ...
 */
export type DF09Cdd0D77475E3293B8 =
  | "simple_average"
 ...
 */
export interface ConvertibleBondWire {
  instrument: DB17B83485Ad38363Fb04;
  schema: D_646268D13067Bb9F9Cb8;
}
export interface DB17B83485Ad38363Fb04 {
  spec: D_5D5C46A56F1A2114A2Ed;
 ...
 */
export interface D_5D5C46A56F1A2114A2Ed {
 ...
 * ```
 */
export interface DE61Aca20D5275E83942B {
  /**
   * Call options (issuer can redeem early).
   */
  calls: D_8B07D188Ef24F2B5A810[];
  /**
   * Put options (holder can redeem early).
   */
  puts: D_8B07D188Ef24F2B5A810[];
}
/**
...
export interface D_8B07D188Ef24F2B5A810 {
   ...
   */
  make_whole?: DF949Ae850Ed7798D02Bd | null;
  /**
 ...
 */
export interface DF949Ae850Ed7798D02Bd {
 ...
 */
export interface D_355963A7Acbc2C62Fdf5 {
  /**
   * Whether accrual-period boundaries are business-day adjusted with
   * `business_day_convention`.
   *
   ...
   */
  payment_lag_days?: number;
  rate_spec: D_14E8725A09F7B41C7021;
  /**
   * Roll-date rule for schedule anchors (standard IMM or CDS IMM grids).
   *
   * [`RollRule::None`] (default) keeps plain tenor stepping. The IMM modes
 ...
 */
export interface D_14E8725A09F7B41C7021 {
  /**
   ...
   */
  overnight_compounding?: DF09Cdd0D77475E3293B8 | null;
  /**
