 ...
 * ```
 */
export type DC8D5A8Dc925586Cc9B9D =
  | {
      months: number;
    }
  | {
 ...
 */
export type D_4B0Fe1Cb7Dcce849Fd27 = "finstack_quant.instrument/1";

/**
 * Canonical single-instrument v1 envelope generated from its serde type.
 */
export interface InflationCapFloorWire {
  instrument: D_6243Ea7003422F0025C1;
  schema: D_4B0Fe1Cb7Dcce849Fd27;
}
export interface D_6243Ea7003422F0025C1 {
  spec: D_2572320F93343Dabe361;
  type: "inflation_cap_floor";
}
/**
 * YoY inflation cap/floor instrument.
 */
export interface D_2572320F93343Dabe361 {
