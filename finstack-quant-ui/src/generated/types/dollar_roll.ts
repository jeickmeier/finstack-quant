 ...
 */
export type D_027D1Db6Ec8C2Ea89A5B = "a" | "b" | "c" | "d";
/**
 * Canonical schema marker for persisted instrument envelopes.
 */
export type DD0Ef2C67Ad49284C4845 = "finstack_quant.instrument/1";

/**
 * Canonical single-instrument v1 envelope generated from its serde type.
 */
export interface DollarRollWire {
  instrument: D_118A287E0C7Ff970F2Af;
  schema: DD0Ef2C67Ad49284C4845;
}
export interface D_118A287E0C7Ff970F2Af {
  spec: D_05625Cf1Aa46E3810Fc5;
  type: "dollar_roll";
}
/**
 ...
 * ```
 */
export interface D_05625Cf1Aa46E3810Fc5 {
  /**
   * Agency program.
   */
   ...
   */
  back_settlement_date?: Date | null;
  /**
   ...
   */
  front_settlement_date?: Date | null;
  /**
   ...
   */
  settlement_class?: D_027D1Db6Ec8C2Ea89A5B | null;
  /**
   * Original loan term.
   */
