 ...
 */
export type D_50863973846B4599663B = "finstack_quant.instrument/1";

/**
 * Canonical single-instrument v1 envelope generated from its serde type.
 */
export interface AgencyMbsPassthroughWire {
  instrument: DD974Fb1239E1Fb4Fd137;
  schema: D_50863973846B4599663B;
}
export interface DD974Fb1239E1Fb4Fd137 {
  spec: D_24B4Bd8Fabf71247Af0B;
 ...
 * ```
 */
export interface D_24B4Bd8Fabf71247Af0B {
  /**
