 ...
 */
export type DDd15732Fc20736602C44 = "a" | "b" | "c" | "d";
/**
 * Canonical schema marker for persisted instrument envelopes.
 */
export type DFdc1Fda2A1E9560D56Df = "finstack_quant.instrument/1";

/**
 * Canonical single-instrument v1 envelope generated from its serde type.
 */
export interface AgencyTbaWire {
  instrument: D_06490C62Ae5862F4C2Ed;
  schema: DFdc1Fda2A1E9560D56Df;
}
export interface D_06490C62Ae5862F4C2Ed {
  spec: D_54049D1588E6Ed129Bca;
  type: "agency_tba";
}
/**
 ...
 * ```
 */
export interface D_54049D1588E6Ed129Bca {
  /**
   ...
   */
  assumed_pool?: D_038Bf279Beea6Aa9Cf48 | null;
   ...
   */
  settlement_class?: DDd15732Fc20736602C44 | null;
  /**
   ...
   * Original loan term.
   */
  term: "fifteen_year" | "twenty_year" | "thirty_year";
  /**
   * Trade date.
   */
  trade_date?: Date1 | null;
  /**
 ...
 * ```
 */
export interface D_038Bf279Beea6Aa9Cf48 {
  /**
   * Agency program (FNMA, FHLMC, GNMA).
   */
  agency: "FNMA" | "FHLMC" | "GNMA_I" | "GNMA_II";
