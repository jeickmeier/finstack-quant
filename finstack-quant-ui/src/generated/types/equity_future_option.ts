 ...
 */
export type D_8C1C7332A53A4Da86Ecb = "finstack_quant.instrument/1";

/**
 * Canonical single-instrument v1 envelope generated from its serde type.
 */
export interface EquityFutureOptionWire {
  instrument: DDf6E58963B38C24D854E;
  schema: D_8C1C7332A53A4Da86Ecb;
}
export interface DDf6E58963B38C24D854E {
  spec: DB38407C5Eb079A4D4Cd0;
  type: "equity_future_option";
}
/**
 * Exchange-listed option on an arbitrary equity or equity-index futures contract.
 */
export interface DB38407C5Eb079A4D4Cd0 {
 ...
 */
export interface DC07D6Aec78E50859E37F {
  /**
   ...
   */
  exercise?: D_4E7B52Df9D2F5B7B156C | null;
  /**
 ...
 */
export interface D_4E7B52Df9D2F5B7B156C {
  date: Date;
  /**
