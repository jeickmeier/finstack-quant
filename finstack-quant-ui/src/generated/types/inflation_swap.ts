 ...
 * ```
 */
export type D_44E203Fc4369B4A47168 =
  | {
      months: number;
    }
  | {
 ...
 */
export type D_03447E7De617567Da496 = "finstack_quant.instrument/1";

/**
 * Canonical single-instrument v1 envelope generated from its serde type.
 */
export interface InflationSwapWire {
  instrument: D_26Dd10486A7C8F849606;
  schema: D_03447E7De617567Da496;
}
export interface D_26Dd10486A7C8F849606 {
  spec: DCf4B2B6Fb1De084C8028;
  type: "inflation_swap";
}
/**
 ...
 */
export interface DCf4B2B6Fb1De084C8028 {
