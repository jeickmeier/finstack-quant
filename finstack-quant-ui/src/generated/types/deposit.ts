 ...
 */
export type DDfe59A0B6C944820167A = "finstack_quant.instrument/1";

/**
 * Canonical single-instrument v1 envelope generated from its serde type.
 */
export interface DepositWire {
  instrument: D_1C927C69467A281351A3;
  schema: DDfe59A0B6C944820167A;
}
export interface D_1C927C69467A281351A3 {
  spec: D_8Dbf50E93309E9Ee85F5;
  type: "deposit";
}
/**
