 ...
 */
export type D_2323F24Ff960639933Fb =
  | {
 ...
 */
export type DCcbdc70B671392748701 = "finstack_quant.instrument/1";

/**
 * Canonical single-instrument v1 envelope generated from its serde type.
 */
export interface TrsFixedIncomeIndexWire {
  instrument: D_29A90D894679A1E11782;
...
export interface DCb8C39A490Fd5E64F385 {
   ...
   */
  margin_spec?: D_9B23D255E9Ed709328D1 | null;
 ...
 * ```
 */
export interface D_9B23D255E9Ed709328D1 {
  /**
   ...
   */
  simm_credit_classification?: D_2323F24Ff960639933Fb | null;
  /**
 ...
 */
export interface D_72Bebdd64B882Acecf70 {
  base_currency: Currency;
  /**
   * Contractual business-day calendar for calls and settlements.
   */
  calendar_id: string;
  call_timing: D_503F723B17F0C04Aff30;
  collateral_curve_id: Id3;
  eligible_collateral: DA3C7E8A7D8Ac959E6C3D;
  /**
   ...
   * or trade is cleared).
   */
  im_params?: D_16219Cd83Aea7D546C03 | null;
  vm_params: DB3867D24415E3Fb4E481;
}
/**
 * Margin call timing parameters.
 */
export interface D_503F723B17F0C04Aff30 {
  /**
 ...
 */
export interface DA3C7E8A7D8Ac959E6C3D {
  /**
   ...
   */
  eligible: D_6C21Eb710465Cd65057E[];
  /**
 ...
 */
export interface D_6C21Eb710465Cd65057E {
  /**
   * Asset class
   */
  asset_class:
   ...
   */
  maturity_constraints?: DB26Dbe8767Fd777474A0 | null;
  /**
 ...
 */
export interface DB26Dbe8767Fd777474A0 {
  /**
 ...
 * ```
 */
export interface D_16219Cd83Aea7D546C03 {
  /**
 ...
 */
export interface DB3867D24415E3Fb4E481 {
  /**
 ...
 */
export interface D_3013Bfcc020829Bbbbd5 {
  end: Date;
