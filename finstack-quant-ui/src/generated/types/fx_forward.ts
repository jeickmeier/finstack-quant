 ...
 */
export type D_605C3B0B209Df681Efb9 = "finstack_quant.instrument/1";

/**
 * Canonical single-instrument v1 envelope generated from its serde type.
 */
export interface FxForwardWire {
  instrument: D_644Fac7163A2Fe78B985;
  schema: D_605C3B0B209Df681Efb9;
}
export interface D_644Fac7163A2Fe78B985 {
  spec: D_5F15F4Bd684Bc813Ff88;
  type: "fx_forward";
}
/**
 ...
 * ```
 */
export interface D_5F15F4Bd684Bc813Ff88 {
