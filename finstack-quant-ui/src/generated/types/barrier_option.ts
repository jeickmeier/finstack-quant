 ...
 */
export type DCaf306029B4817Be505A = "finstack_quant.instrument/1";

/**
 * Canonical single-instrument v1 envelope generated from its serde type.
 */
export interface BarrierOptionWire {
  instrument: D_32035D86067Ce1D21B62;
  schema: DCaf306029B4817Be505A;
}
export interface D_32035D86067Ce1D21B62 {
  spec: D_95Df9E3F9Fb8D601Ef0B;
  type: "barrier_option";
}
/**
