 ...
 */
export type DE82Bf0789C2D46Eedbc9 = "finstack_quant.instrument/1";

/**
 * Canonical single-instrument v1 envelope generated from its serde type.
 */
export interface FxBarrierOptionWire {
  instrument: DC243Aa9B92B503A0Bae7;
  schema: DE82Bf0789C2D46Eedbc9;
}
export interface DC243Aa9B92B503A0Bae7 {
  spec: D_9F54E6F1A3C511F443A0;
  type: "fx_barrier_option";
}
/**
 * FX barrier option instrument.
 */
export interface D_9F54E6F1A3C511F443A0 {
