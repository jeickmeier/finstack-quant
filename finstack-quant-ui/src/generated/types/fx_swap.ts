 ...
 */
export type D_78E5130B2D2C264F2D8E = "finstack_quant.instrument/1";

/**
 * Canonical single-instrument v1 envelope generated from its serde type.
 */
export interface FxSwapWire {
  instrument: D_51Cdb8B0372Bf0Cbdfa3;
  schema: D_78E5130B2D2C264F2D8E;
}
export interface D_51Cdb8B0372Bf0Cbdfa3 {
  spec: D_17Ebaf6Bae7Cbde5673D;
  type: "fx_swap";
}
/**
 * FX Swap instrument definition
 */
export interface D_17Ebaf6Bae7Cbde5673D {
