 ...
 */
export type D_49232Badf4120Fe6Dc21 = "finstack_quant.instrument/1";

/**
 * Canonical single-instrument v1 envelope generated from its serde type.
 */
export interface EquityTotalReturnFutureWire {
  instrument: D_5E2825Df00Bb3Dc0672A;
  schema: D_49232Badf4120Fe6Dc21;
}
export interface D_5E2825Df00Bb3Dc0672A {
  spec: D_550000D43Fff1562676A;
 ...
 */
export interface D_550000D43Fff1562676A {
  accrued_distributions_id: Id;
  accrued_funding_id: Id1;
  ...
  spot_id: Id3;
  spread_basis_points_id: Id4;
  spread_day_count: DayCount;
  terms: D_9774Aa944999351Eb9D1;
  /**
 ...
 */
export interface D_9774Aa944999351Eb9D1 {
  /**
