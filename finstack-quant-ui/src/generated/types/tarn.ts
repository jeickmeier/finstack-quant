 ...
 */
export type D_6F582Ccbc5F53E480974 = "finstack_quant.instrument/1";

/**
 * Canonical single-instrument v1 envelope generated from its serde type.
 */
export interface TarnWire {
  instrument: D_66F596B430C73F0A0656;
  schema: D_6F582Ccbc5F53E480974;
}
export interface D_66F596B430C73F0A0656 {
  spec: D_8Af284Dde09995F0Ad8C;
  type: "tarn";
}
/**
