 ...
 */
export type D_77939Ed0F28B7Ca14B56 = "finstack_quant.instrument/1";

/**
 * Canonical single-instrument v1 envelope generated from its serde type.
 */
export interface InflationLinkedBondWire {
  instrument: DD5865E0389Fd175A593A;
  schema: D_77939Ed0F28B7Ca14B56;
}
export interface DD5865E0389Fd175A593A {
  spec: DCf0Ae253Da617678Cc3E;
