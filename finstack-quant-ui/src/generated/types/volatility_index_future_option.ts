 ...
 */
export type DA613A65F0117722E334B = "finstack_quant.instrument/1";

/**
 * Canonical single-instrument v1 envelope generated from its serde type.
 */
export interface VolatilityIndexFutureOptionWire {
  instrument: DF9Bb6Ce38Cb4F3386856;
  schema: DA613A65F0117722E334B;
}
export interface DF9Bb6Ce38Cb4F3386856 {
  spec: DC86A948C3946B4Db57C6;
  type: "volatility_index_future_option";
}
/**
 * Exchange-listed option on a volatility-index futures contract.
 */
export interface DC86A948C3946B4Db57C6 {
 ...
 */
export interface D_7405A94895987B0B7035 {
  /**
   ...
   */
  exercise?: DB012E0B54B6F5F34C604 | null;
  /**
 ...
 */
export interface DB012E0B54B6F5F34C604 {
  date: Date;
  /**
