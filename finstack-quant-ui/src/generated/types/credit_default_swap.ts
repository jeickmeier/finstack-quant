 ...
 * ```
 */
export type D_9F2015Dceb8C80D6E4D1 =
 ...
 */
export type DF46Af261Bc49B6Bec18A =
  | {
 ...
 */
export type DC371D9657704Dff1Daf6 = "finstack_quant.instrument/1";

/**
 * Canonical single-instrument v1 envelope generated from its serde type.
 */
export interface CreditDefaultSwapWire {
  instrument: D_95Eee272A5Df2E4Ddf86;
  schema: DC371D9657704Dff1Daf6;
}
export interface D_95Eee272A5Df2E4Ddf86 {
  spec: D_8Af4C7B7Cd300C5C83F1;
 ...
 */
export interface D_8Af4C7B7Cd300C5C83F1 {
   ...
   */
  doc_clause?: D_9F2015Dceb8C80D6E4D1 | null;
  id: Id;
 ...
 * ```
 */
export interface D_7B94C5F3C5A73Dd2Ae20 {
  /**
 ...
 */
export interface D_2114D69E1F4415D022A9 {
  base_currency: Currency;
  /**
   * Contractual business-day calendar for calls and settlements.
   */
  calendar_id: string;
  call_timing: D_98Ba3B47Cdc1Bf425Be4;
  collateral_curve_id: Id1;
  eligible_collateral: DF94493549Cb5Ab005E8C;
  /**
   ...
   * or trade is cleared).
   */
  im_params?: D_689F3Cd8Deb433E8F1B4 | null;
  vm_params: D_346928387A11C641C3Eb;
}
/**
 * Margin call timing parameters.
 */
export interface D_98Ba3B47Cdc1Bf425Be4 {
  /**
 ...
 */
export interface DF94493549Cb5Ab005E8C {
  /**
   ...
   */
  eligible: DB5178Cc49C8596696Df6[];
  /**
 ...
 */
export interface DB5178Cc49C8596696Df6 {
  /**
   * Asset class
   */
  asset_class:
   ...
   */
  maturity_constraints?: D_135925D82Ca0C99Fc50D | null;
  /**
 ...
 */
export interface D_135925D82Ca0C99Fc50D {
  /**
 ...
 * ```
 */
export interface D_689F3Cd8Deb433E8F1B4 {
  /**
 ...
 */
export interface D_346928387A11C641C3Eb {
  /**
 ...
 */
export interface DAa1B03A4B2041456F32B {
