 ...
 */
export type D_163Fff815Fc5A512F1Bb = "finstack_quant.instrument/1";

/**
 * Canonical single-instrument v1 envelope generated from its serde type.
 */
export interface VolatilityIndexFutureWire {
  instrument: DE1Bd96Bcaa7Ce74B7D1D;
  schema: D_163Fff815Fc5A512F1Bb;
}
export interface DE1Bd96Bcaa7Ce74B7D1D {
  spec: DF5452489Af2759Ebedff;
