 ...
 */
export type D_75B298C8759C7971D10A = "finstack_quant.instrument/1";

/**
 * Canonical single-instrument v1 envelope generated from its serde type.
 */
export interface FxFutureOptionWire {
  instrument: DD1B016D4A33A2A44D22F;
  schema: D_75B298C8759C7971D10A;
}
export interface DD1B016D4A33A2A44D22F {
  spec: DA8A34604244A01F1Ac8F;
  type: "fx_future_option";
}
/**
 * Exchange-listed option on an arbitrary FX futures contract.
 */
export interface DA8A34604244A01F1Ac8F {
 ...
 */
export interface DA58B91D3A6B980Ee5023 {
  /**
   ...
   */
  exercise?: D_3A1A7Daa5D3604B6C0B0 | null;
  /**
 ...
 */
export interface D_3A1A7Daa5D3604B6C0B0 {
  date: Date;
  /**
