...
export default [
  {
    "path": "#",
    "source": "https://finstack_quant.dev/schemas/instrument/1/commodity/commodity_forward.schema.json#",
  ...
  {
    "path": "#/$defs/d_1513b9a1f6ad9f857fe3",
    "source": "https://finstack_quant.dev/schemas/instrument/1/commodity/commodity_forward.schema.json#/$defs/InstrumentSchema",
  ...
  {
    "path": "#/$defs/d_54a217fa61a3d2b92f99",
    "source": "https://finstack_quant.dev/schemas/instrument/1/commodity/commodity_forward.schema.json#/$defs/Position",
    "description": "Position direction for futures and forwards."
  },
  {
    "path": "#/$defs/d_54a217fa61a3d2b92f99/oneOf/0",
    "source": "https://finstack_quant.dev/schemas/instrument/1/commodity/commodity_forward.schema.json#/$defs/Position/oneOf/0",
    "const": "long",
    "description": "Long position (buyer of the contract)."
  },
  {
    "path": "#/$defs/d_54a217fa61a3d2b92f99/oneOf/1",
    "source": "https://finstack_quant.dev/schemas/instrument/1/commodity/commodity_forward.schema.json#/$defs/Position/oneOf/1",
    "const": "short",
  ...
  {
    "path": "#/$defs/d_a38276db343bce9463b5",
    "source": "https://finstack_quant.dev/schemas/instrument/1/commodity/commodity_forward.schema.json#/$defs/commodity_forward"
  },
  {
    "path": "#/$defs/d_a38276db343bce9463b5/properties/spec",
    "source": "https://finstack_quant.dev/schemas/instrument/1/commodity/commodity_forward.schema.json#/$defs/commodity_forward/properties/spec",
    "ref": "#/$defs/CommodityForward",
    "resolvedRef": "https://finstack_quant.dev/schemas/instrument/1/commodity/commodity_forward.schema.json#/$defs/CommodityForward"
  },
  {
    "path": "#/$defs/d_a38276db343bce9463b5/properties/type",
    "source": "https://finstack_quant.dev/schemas/instrument/1/commodity/commodity_forward.schema.json#/$defs/commodity_forward/properties/type",
    "const": "commodity_forward"
  },
  {
  ...
  {
    "path": "#/$defs/d_b9a7fb5e1ed29fc5ecd5",
    "source": "https://finstack_quant.dev/schemas/instrument/1/commodity/commodity_forward.schema.json#/$defs/PositiveF64Wire",
  ...
  {
    "path": "#/$defs/d_c536dd95cca90beb9661",
    "source": "https://finstack_quant.dev/schemas/instrument/1/commodity/commodity_forward.schema.json#/$defs/CommodityConvention",
    "description": "Standard commodity market conventions by product type.\n\nEach variant provides market-standard defaults for settlement days,\nbusiness day convention, and calendar. Use when constructing commodity\nforwards, options, or swaps without explicitly specifying these parameters.\n\n# Market Standards Reference\n\n| Convention | Settlement | BDC | Calendar | Exchange |\n|------------|------------|-----|----------|----------|\n| WTI Crude | T+2 | Following | NYMEX | NYMEX/CME |\n| Brent Crude | T+2 | Following | ICE | ICE |\n| Natural Gas | T+2 | Following | NYMEX | NYMEX/CME |\n| Gold | T+2 | Modified Following | COMEX | CME |\n| Silver | T+2 | Modified Following | COMEX | CME |\n| Copper | T+2 | Following | LME | LME |\n| Corn/Wheat | T+2 | Following | CBOT | CME |\n| Power | T+1 | Modified Following | NERC | Various |\n\n# Sources\n\n- CME Group rulebooks\n- ICE Futures exchange rules\n- LME trading procedures"
  },
  {
    "path": "#/$defs/d_c536dd95cca90beb9661/oneOf/0",
    "source": "https://finstack_quant.dev/schemas/instrument/1/commodity/commodity_forward.schema.json#/$defs/CommodityConvention/oneOf/0",
    "const": "wti_crude",
    "description": "WTI Crude Oil: T+2, Following, NYMEX calendar"
  },
  {
    "path": "#/$defs/d_c536dd95cca90beb9661/oneOf/1",
    "source": "https://finstack_quant.dev/schemas/instrument/1/commodity/commodity_forward.schema.json#/$defs/CommodityConvention/oneOf/1",
    "const": "brent_crude",
    "description": "Brent Crude Oil: T+2, Following, ICE calendar"
  },
  {
    "path": "#/$defs/d_c536dd95cca90beb9661/oneOf/2",
    "source": "https://finstack_quant.dev/schemas/instrument/1/commodity/commodity_forward.schema.json#/$defs/CommodityConvention/oneOf/2",
    "const": "natural_gas",
    "description": "Henry Hub Natural Gas: T+2, Following, NYMEX calendar"
  },
  {
    "path": "#/$defs/d_c536dd95cca90beb9661/oneOf/3",
    "source": "https://finstack_quant.dev/schemas/instrument/1/commodity/commodity_forward.schema.json#/$defs/CommodityConvention/oneOf/3",
    "const": "gold",
    "description": "COMEX Gold: T+2, Modified Following, COMEX calendar"
  },
  {
    "path": "#/$defs/d_c536dd95cca90beb9661/oneOf/4",
    "source": "https://finstack_quant.dev/schemas/instrument/1/commodity/commodity_forward.schema.json#/$defs/CommodityConvention/oneOf/4",
    "const": "silver",
    "description": "COMEX Silver: T+2, Modified Following, COMEX calendar"
  },
  {
    "path": "#/$defs/d_c536dd95cca90beb9661/oneOf/5",
    "source": "https://finstack_quant.dev/schemas/instrument/1/commodity/commodity_forward.schema.json#/$defs/CommodityConvention/oneOf/5",
    "const": "copper",
    "description": "LME Copper: T+2, Following, LME calendar"
  },
  {
    "path": "#/$defs/d_c536dd95cca90beb9661/oneOf/6",
    "source": "https://finstack_quant.dev/schemas/instrument/1/commodity/commodity_forward.schema.json#/$defs/CommodityConvention/oneOf/6",
    "const": "agricultural",
    "description": "CBOT Agricultural (Corn, Wheat, Soybeans): T+2, Following, CBOT calendar"
  },
  {
    "path": "#/$defs/d_c536dd95cca90beb9661/oneOf/7",
    "source": "https://finstack_quant.dev/schemas/instrument/1/commodity/commodity_forward.schema.json#/$defs/CommodityConvention/oneOf/7",
    "const": "power",
    "description": "Power/Electricity: T+1, Modified Following, NERC calendar"
  },
  {
  ...
  {
    "path": "#/$defs/d_d2986402f9d59a555abc",
    "source": "https://finstack_quant.dev/schemas/instrument/1/commodity/commodity_forward.schema.json#/$defs/SettlementType",
    "description": "Settlement type for options"
  },
  {
    "path": "#/$defs/d_d2986402f9d59a555abc/oneOf/0",
    "source": "https://finstack_quant.dev/schemas/instrument/1/commodity/commodity_forward.schema.json#/$defs/SettlementType/oneOf/0",
    "const": "physical",
    "description": "Physical delivery"
  },
  {
    "path": "#/$defs/d_d2986402f9d59a555abc/oneOf/1",
    "source": "https://finstack_quant.dev/schemas/instrument/1/commodity/commodity_forward.schema.json#/$defs/SettlementType/oneOf/1",
    "const": "cash",
    "description": "Cash settlement"
  },
  {
    "path": "#/$defs/d_d34fe8d294aafaa3e650",
    "source": "https://finstack_quant.dev/schemas/instrument/1/commodity/commodity_forward.schema.json#/$defs/CommodityForward",
  ...
  {
    "path": "#/$defs/d_d34fe8d294aafaa3e650/properties/attributes",
    "source": "https://finstack_quant.dev/schemas/instrument/1/commodity/commodity_forward.schema.json#/$defs/CommodityForward/properties/attributes",
    "default": {},
  ...
  {
    "path": "#/$defs/d_d34fe8d294aafaa3e650/properties/commodity_type",
    "source": "https://finstack_quant.dev/schemas/instrument/1/commodity/commodity_forward.schema.json#/$defs/CommodityForward/properties/commodity_type",
    "description": "Commodity type (e.g., \"Energy\", \"Metal\", \"Agricultural\")"
  },
  {
    "path": "#/$defs/d_d34fe8d294aafaa3e650/properties/contract_month",
    "source": "https://finstack_quant.dev/schemas/instrument/1/commodity/commodity_forward.schema.json#/$defs/CommodityForward/properties/contract_month",
    "description": "Optional contract month (e.g., \"2025M03\" for March 2025)."
  },
  {
    "path": "#/$defs/d_d34fe8d294aafaa3e650/properties/contract_price",
    "source": "https://finstack_quant.dev/schemas/instrument/1/commodity/commodity_forward.schema.json#/$defs/CommodityForward/properties/contract_price",
    "description": "Contract price (entry/trade price K).\n\nIf `None`, the forward is treated as **at-market** (K = F), meaning\nNPV ≈ 0 at inception (like a newly opened futures position).\n\nIf `Some(K)`, the forward is **off-market** and NPV reflects the\nmark-to-market difference: sign × (F - K) × Q × M × DF.",
    "format": "double"
  },
  {
    "path": "#/$defs/d_d34fe8d294aafaa3e650/properties/convention",
    "source": "https://finstack_quant.dev/schemas/instrument/1/commodity/commodity_forward.schema.json#/$defs/CommodityForward/properties/convention",
    "description": "Optional market convention for this commodity.\n\nWhen set, provides default settlement days and calendar if not\nexplicitly specified. See `CommodityConvention` for available options."
  },
  {
    "path": "#/$defs/d_d34fe8d294aafaa3e650/properties/convention/anyOf/0",
    "source": "https://finstack_quant.dev/schemas/instrument/1/commodity/commodity_forward.schema.json#/$defs/CommodityForward/properties/convention/anyOf/0",
    "ref": "#/$defs/CommodityConvention",
    "resolvedRef": "https://finstack_quant.dev/schemas/instrument/1/commodity/commodity_forward.schema.json#/$defs/CommodityConvention"
  },
  {
    "path": "#/$defs/d_d34fe8d294aafaa3e650/properties/convention/anyOf/1",
    "source": "https://finstack_quant.dev/schemas/instrument/1/commodity/commodity_forward.schema.json#/$defs/CommodityForward/properties/convention/anyOf/1"
  },
  {
    "path": "#/$defs/d_d34fe8d294aafaa3e650/properties/currency",
    "source": "https://finstack_quant.dev/schemas/instrument/1/commodity/commodity_forward.schema.json#/$defs/CommodityForward/properties/currency",
  ...
  {
    "path": "#/$defs/d_d34fe8d294aafaa3e650/properties/discount_curve_id",
    "source": "https://finstack_quant.dev/schemas/instrument/1/commodity/commodity_forward.schema.json#/$defs/CommodityForward/properties/discount_curve_id",
  ...
  {
    "path": "#/$defs/d_d34fe8d294aafaa3e650/properties/exchange",
    "source": "https://finstack_quant.dev/schemas/instrument/1/commodity/commodity_forward.schema.json#/$defs/CommodityForward/properties/exchange",
    "description": "Optional exchange identifier (e.g., \"NYMEX\", \"ICE\")."
  },
  {
    "path": "#/$defs/d_d34fe8d294aafaa3e650/properties/forward_curve_id",
    "source": "https://finstack_quant.dev/schemas/instrument/1/commodity/commodity_forward.schema.json#/$defs/CommodityForward/properties/forward_curve_id",
    "description": "Forward/futures price curve ID for price interpolation.\n\nShould reference a `PriceCurve` in the `MarketContext`.",
    "ref": "https://finstack_quant.dev/schemas/common/1/id.schema.json",
    "resolvedRef": "https://finstack_quant.dev/schemas/common/1/id.schema.json#"
  },
  {
    "path": "#/$defs/d_d34fe8d294aafaa3e650/properties/id",
    "source": "https://finstack_quant.dev/schemas/instrument/1/commodity/commodity_forward.schema.json#/$defs/CommodityForward/properties/id",
    "description": "Unique instrument identifier.",
    "ref": "https://finstack_quant.dev/schemas/common/1/id.schema.json",
    "resolvedRef": "https://finstack_quant.dev/schemas/common/1/id.schema.json#"
  },
  {
    "path": "#/$defs/d_d34fe8d294aafaa3e650/properties/instrument_pricing_overrides",
    "source": "https://finstack_quant.dev/schemas/instrument/1/commodity/commodity_forward.schema.json#/$defs/CommodityForward/properties/instrument_pricing_overrides",
  ...
  {
    "path": "#/$defs/d_d34fe8d294aafaa3e650/properties/maturity",
    "source": "https://finstack_quant.dev/schemas/instrument/1/commodity/commodity_forward.schema.json#/$defs/CommodityForward/properties/maturity",
  ...
  {
    "path": "#/$defs/d_d34fe8d294aafaa3e650/properties/metric_pricing_overrides",
    "source": "https://finstack_quant.dev/schemas/instrument/1/commodity/commodity_forward.schema.json#/$defs/CommodityForward/properties/metric_pricing_overrides",
  ...
  {
    "path": "#/$defs/d_d34fe8d294aafaa3e650/properties/multiplier",
    "source": "https://finstack_quant.dev/schemas/instrument/1/commodity/commodity_forward.schema.json#/$defs/CommodityForward/properties/multiplier",
    "default": 1,
    "description": "Contract multiplier (typically 1.0 for OTC forwards, defaults to 1.0).",
    "ref": "#/$defs/PositiveF64Wire",
    "resolvedRef": "https://finstack_quant.dev/schemas/instrument/1/commodity/commodity_forward.schema.json#/$defs/PositiveF64Wire"
  },
  {
    "path": "#/$defs/d_d34fe8d294aafaa3e650/properties/position",
    "source": "https://finstack_quant.dev/schemas/instrument/1/commodity/commodity_forward.schema.json#/$defs/CommodityForward/properties/position",
    "default": "long",
    ...
    "ref": "#/$defs/Position",
    "resolvedRef": "https://finstack_quant.dev/schemas/instrument/1/commodity/commodity_forward.schema.json#/$defs/Position"
  },
  {
    "path": "#/$defs/d_d34fe8d294aafaa3e650/properties/quantity",
    "source": "https://finstack_quant.dev/schemas/instrument/1/commodity/commodity_forward.schema.json#/$defs/CommodityForward/properties/quantity",
    "description": "Contract quantity in units.",
    "ref": "#/$defs/PositiveF64Wire",
    "resolvedRef": "https://finstack_quant.dev/schemas/instrument/1/commodity/commodity_forward.schema.json#/$defs/PositiveF64Wire"
  },
  {
    "path": "#/$defs/d_d34fe8d294aafaa3e650/properties/quoted_price",
    "source": "https://finstack_quant.dev/schemas/instrument/1/commodity/commodity_forward.schema.json#/$defs/CommodityForward/properties/quoted_price",
  ...
  {
    "path": "#/$defs/d_d34fe8d294aafaa3e650/properties/scenario_pricing_overrides",
    "source": "https://finstack_quant.dev/schemas/instrument/1/commodity/commodity_forward.schema.json#/$defs/CommodityForward/properties/scenario_pricing_overrides",
  ...
  {
    "path": "#/$defs/d_d34fe8d294aafaa3e650/properties/settlement",
    "source": "https://finstack_quant.dev/schemas/instrument/1/commodity/commodity_forward.schema.json#/$defs/CommodityForward/properties/settlement",
    "default": "cash",
    "description": "Settlement type (physical or cash).\n\nDefaults to cash settlement when omitted in serialized payloads.",
    "ref": "#/$defs/SettlementType",
    "resolvedRef": "https://finstack_quant.dev/schemas/instrument/1/commodity/commodity_forward.schema.json#/$defs/SettlementType"
  },
  {
    "path": "#/$defs/d_d34fe8d294aafaa3e650/properties/settlement_business_day_convention",
    "source": "https://finstack_quant.dev/schemas/instrument/1/commodity/commodity_forward.schema.json#/$defs/CommodityForward/properties/settlement_business_day_convention",
    "description": "Business day convention for settlement date adjustment.\n\nDefaults to `Following` for energy commodities, `ModifiedFollowing`\nfor precious metals."
  },
  {
    "path": "#/$defs/d_d34fe8d294aafaa3e650/properties/settlement_business_day_convention/anyOf/0",
    "source": "https://finstack_quant.dev/schemas/instrument/1/commodity/commodity_forward.schema.json#/$defs/CommodityForward/properties/settlement_business_day_convention/anyOf/0",
  ...
  {
    "path": "#/$defs/d_d34fe8d294aafaa3e650/properties/settlement_business_day_convention/anyOf/1",
    "source": "https://finstack_quant.dev/schemas/instrument/1/commodity/commodity_forward.schema.json#/$defs/CommodityForward/properties/settlement_business_day_convention/anyOf/1"
  },
  {
    "path": "#/$defs/d_d34fe8d294aafaa3e650/properties/settlement_calendar_id",
    "source": "https://finstack_quant.dev/schemas/instrument/1/commodity/commodity_forward.schema.json#/$defs/CommodityForward/properties/settlement_calendar_id",
  ...
  {
    "path": "#/$defs/d_d34fe8d294aafaa3e650/properties/settlement_lag_days",
    "source": "https://finstack_quant.dev/schemas/instrument/1/commodity/commodity_forward.schema.json#/$defs/CommodityForward/properties/settlement_lag_days",
  ...
  {
    "path": "#/$defs/d_d34fe8d294aafaa3e650/properties/spot_id",
    "source": "https://finstack_quant.dev/schemas/instrument/1/commodity/commodity_forward.schema.json#/$defs/CommodityForward/properties/spot_id",
  ...
  },
  {
    ...
    "source": "https://finstack_quant.dev/schemas/instrument/1/commodity/commodity_forward.schema.json#/$defs/CommodityForward/properties/unit",
    "description": "Unit of measurement (e.g., \"BBL\", \"OZ\", \"MT\", \"MMBTU\")"
  },
  {
  ...
  },
  {
    ...
    "source": "https://finstack_quant.dev/schemas/instrument/1/commodity/commodity_forward.schema.json#/properties/instrument",
    "ref": "#/$defs/commodity_forward",
    "resolvedRef": "https://finstack_quant.dev/schemas/instrument/1/commodity/commodity_forward.schema.json#/$defs/commodity_forward"
  },
  {
    "path": "#/properties/schema",
    "source": "https://finstack_quant.dev/schemas/instrument/1/commodity/commodity_forward.schema.json#/properties/schema",
    "ref": "#/$defs/InstrumentSchema",
    "resolvedRef": "https://finstack_quant.dev/schemas/instrument/1/commodity/commodity_forward.schema.json#/$defs/InstrumentSchema"
  }
];
