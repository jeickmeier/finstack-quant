...
export default [
  {
    "path": "#",
    "source": "https://finstack_quant.dev/schemas/instrument/1/equity/equity_option.schema.json#",
  ...
  {
    "path": "#/$defs/d_0acab18b1f18f946b5f9",
    "source": "https://finstack_quant.dev/schemas/instrument/1/equity/equity_option.schema.json#/$defs/ThetaDayBasis",
    "description": "Day basis used to convert annual option theta into a per-day amount."
  },
  {
    "path": "#/$defs/d_0acab18b1f18f946b5f9/oneOf/0",
    "source": "https://finstack_quant.dev/schemas/instrument/1/equity/equity_option.schema.json#/$defs/ThetaDayBasis/oneOf/0",
    "const": "calendar_365",
    "description": "Calendar-day theta, annual theta divided by 365."
  },
  {
    "path": "#/$defs/d_0acab18b1f18f946b5f9/oneOf/1",
    "source": "https://finstack_quant.dev/schemas/instrument/1/equity/equity_option.schema.json#/$defs/ThetaDayBasis/oneOf/1",
    "const": "trading_252",
  ...
  {
    "path": "#/$defs/d_2f5d441d7c3b7cd29f67",
    "source": "https://finstack_quant.dev/schemas/instrument/1/equity/equity_option.schema.json#/$defs/EquityOption",
    "description": "Equity option instrument"
  },
  {
    "path": "#/$defs/d_2f5d441d7c3b7cd29f67/properties/attributes",
    "source": "https://finstack_quant.dev/schemas/instrument/1/equity/equity_option.schema.json#/$defs/EquityOption/properties/attributes",
  ...
  {
    "path": "#/$defs/d_2f5d441d7c3b7cd29f67/properties/day_count",
    "source": "https://finstack_quant.dev/schemas/instrument/1/equity/equity_option.schema.json#/$defs/EquityOption/properties/day_count",
    "default": "act_365f",
    "description": "Model year fraction for volatility, dividend carry and exercise times; defaults to ACT/365F. Discount factors retain the curve's own date convention.",
  ...
  {
    "path": "#/$defs/d_2f5d441d7c3b7cd29f67/properties/discount_curve_id",
    "source": "https://finstack_quant.dev/schemas/instrument/1/equity/equity_option.schema.json#/$defs/EquityOption/properties/discount_curve_id",
  ...
  {
    "path": "#/$defs/d_2f5d441d7c3b7cd29f67/properties/discrete_dividends",
    "source": "https://finstack_quant.dev/schemas/instrument/1/equity/equity_option.schema.json#/$defs/EquityOption/properties/discrete_dividends",
    "default": [],
    "description": "Optional discrete dividend schedule for more accurate pricing.\n\nEach entry is (ex-date, dividend_amount). When provided, the escrowed\ndividend model is used: the spot price is adjusted by subtracting the\nPV of future dividends before option pricing.\n\n# Escrowed Dividend Model\n\nThe adjusted spot is:\n```text\nS* = S - Σ D_i × DF(t_i)\n```\nwhere D_i is each dividend amount and DF(t_i) is the discount factor\nto the ex-date. The adjusted spot S* is then used in Black-Scholes\nwith zero dividend yield.\n\n# Reference\n\n- Haug, Haug, Lewis (2003). \"Back to Basics: a new approach to the\n  discrete dividend problem\""
  },
  {
    "path": "#/$defs/d_2f5d441d7c3b7cd29f67/properties/discrete_dividends/items",
    "source": "https://finstack_quant.dev/schemas/instrument/1/equity/equity_option.schema.json#/$defs/EquityOption/properties/discrete_dividends/items"
  },
  {
    "path": "#/$defs/d_2f5d441d7c3b7cd29f67/properties/discrete_dividends/items/prefixItems/0",
    "source": "https://finstack_quant.dev/schemas/instrument/1/equity/equity_option.schema.json#/$defs/EquityOption/properties/discrete_dividends/items/prefixItems/0",
  ...
  {
    "path": "#/$defs/d_2f5d441d7c3b7cd29f67/properties/discrete_dividends/items/prefixItems/1",
    "source": "https://finstack_quant.dev/schemas/instrument/1/equity/equity_option.schema.json#/$defs/EquityOption/properties/discrete_dividends/items/prefixItems/1",
    "format": "double"
  },
  {
    "path": "#/$defs/d_2f5d441d7c3b7cd29f67/properties/div_yield_id",
    "source": "https://finstack_quant.dev/schemas/instrument/1/equity/equity_option.schema.json#/$defs/EquityOption/properties/div_yield_id",
    "description": "Optional continuous dividend yield identifier.\n\nThe dividend yield should be a unitless scalar representing the annualized\ncontinuous dividend yield (e.g., 0.02 for 2%). This is used in the BSM model\nas the `q` parameter: `d1 = (ln(S/K) + (r - q + σ²/2)T) / (σ√T)`.\n\n# Semantics by value\n\n- **`Some(id)`** — the lookup MUST succeed. A missing market scalar\n  (or a non-unitless type) returns a hard error rather than silently\n  defaulting to zero, preventing market-data configuration errors\n  from quietly distorting P&L.\n- **`None`** — there is *no implicit default curve*. The pricer treats\n  the underlying as having **zero continuous dividend yield**. This is\n  correct for non-dividend-paying single stocks; for index options\n  (typically ~2% yield) callers should set `div_yield_id` explicitly.\n\nIf `discrete_dividends` is non-empty, an escrowed-dividend adjustment\nis applied to spot and `q` is set to 0 internally regardless of\n`div_yield_id`."
  },
  {
    "path": "#/$defs/d_2f5d441d7c3b7cd29f67/properties/div_yield_id/anyOf/0",
    "source": "https://finstack_quant.dev/schemas/instrument/1/equity/equity_option.schema.json#/$defs/EquityOption/properties/div_yield_id/anyOf/0",
    "ref": "https://finstack_quant.dev/schemas/common/1/id.schema.json",
    "resolvedRef": "https://finstack_quant.dev/schemas/common/1/id.schema.json#"
  },
  {
    "path": "#/$defs/d_2f5d441d7c3b7cd29f67/properties/div_yield_id/anyOf/1",
    "source": "https://finstack_quant.dev/schemas/instrument/1/equity/equity_option.schema.json#/$defs/EquityOption/properties/div_yield_id/anyOf/1"
  },
  {
    "path": "#/$defs/d_2f5d441d7c3b7cd29f67/properties/exercise",
    "source": "https://finstack_quant.dev/schemas/instrument/1/equity/equity_option.schema.json#/$defs/EquityOption/properties/exercise",
  ...
  {
    "path": "#/$defs/d_2f5d441d7c3b7cd29f67/properties/exercise_schedule",
    "source": "https://finstack_quant.dev/schemas/instrument/1/equity/equity_option.schema.json#/$defs/EquityOption/properties/exercise_schedule",
  ...
  {
    "path": "#/$defs/d_2f5d441d7c3b7cd29f67/properties/exercise_schedule/items",
    "source": "https://finstack_quant.dev/schemas/instrument/1/equity/equity_option.schema.json#/$defs/EquityOption/properties/exercise_schedule/items",
    "ref": "https://finstack_quant.dev/schemas/common/1/date.schema.json",
    "resolvedRef": "https://finstack_quant.dev/schemas/common/1/date.schema.json#"
  },
  {
    "path": "#/$defs/d_2f5d441d7c3b7cd29f67/properties/exercise_style",
    "source": "https://finstack_quant.dev/schemas/instrument/1/equity/equity_option.schema.json#/$defs/EquityOption/properties/exercise_style",
    "default": "european",
    "description": "Exercise style (European or American)",
    "ref": "#/$defs/ExerciseStyle",
    "resolvedRef": "https://finstack_quant.dev/schemas/instrument/1/equity/equity_option.schema.json#/$defs/ExerciseStyle"
  },
  {
    "path": "#/$defs/d_2f5d441d7c3b7cd29f67/properties/exercise/anyOf/0",
    "source": "https://finstack_quant.dev/schemas/instrument/1/equity/equity_option.schema.json#/$defs/EquityOption/properties/exercise/anyOf/0",
    "ref": "#/$defs/EquityOptionExercise",
    "resolvedRef": "https://finstack_quant.dev/schemas/instrument/1/equity/equity_option.schema.json#/$defs/EquityOptionExercise"
  },
  {
    "path": "#/$defs/d_2f5d441d7c3b7cd29f67/properties/exercise/anyOf/1",
    "source": "https://finstack_quant.dev/schemas/instrument/1/equity/equity_option.schema.json#/$defs/EquityOption/properties/exercise/anyOf/1"
  },
  {
    "path": "#/$defs/d_2f5d441d7c3b7cd29f67/properties/expiry",
    "source": "https://finstack_quant.dev/schemas/instrument/1/equity/equity_option.schema.json#/$defs/EquityOption/properties/expiry",
    "description": "Option expiry date",
    "ref": "https://finstack_quant.dev/schemas/common/1/date.schema.json",
    "resolvedRef": "https://finstack_quant.dev/schemas/common/1/date.schema.json#"
  },
  {
    "path": "#/$defs/d_2f5d441d7c3b7cd29f67/properties/id",
    "source": "https://finstack_quant.dev/schemas/instrument/1/equity/equity_option.schema.json#/$defs/EquityOption/properties/id",
    "description": "Unique instrument identifier",
    "ref": "https://finstack_quant.dev/schemas/common/1/id.schema.json",
    "resolvedRef": "https://finstack_quant.dev/schemas/common/1/id.schema.json#"
  },
  {
    "path": "#/$defs/d_2f5d441d7c3b7cd29f67/properties/instrument_pricing_overrides",
    "source": "https://finstack_quant.dev/schemas/instrument/1/equity/equity_option.schema.json#/$defs/EquityOption/properties/instrument_pricing_overrides",
  ...
  {
    "path": "#/$defs/d_2f5d441d7c3b7cd29f67/properties/metric_pricing_overrides",
    "source": "https://finstack_quant.dev/schemas/instrument/1/equity/equity_option.schema.json#/$defs/EquityOption/properties/metric_pricing_overrides",
  ...
  {
    "path": "#/$defs/d_2f5d441d7c3b7cd29f67/properties/notional",
    "source": "https://finstack_quant.dev/schemas/instrument/1/equity/equity_option.schema.json#/$defs/EquityOption/properties/notional",
  ...
  {
    "path": "#/$defs/d_2f5d441d7c3b7cd29f67/properties/option_type",
    "source": "https://finstack_quant.dev/schemas/instrument/1/equity/equity_option.schema.json#/$defs/EquityOption/properties/option_type",
    "description": "Option type (call or put)",
    "ref": "#/$defs/OptionType",
    "resolvedRef": "https://finstack_quant.dev/schemas/instrument/1/equity/equity_option.schema.json#/$defs/OptionType"
  },
  {
    "path": "#/$defs/d_2f5d441d7c3b7cd29f67/properties/scenario_pricing_overrides",
    "source": "https://finstack_quant.dev/schemas/instrument/1/equity/equity_option.schema.json#/$defs/EquityOption/properties/scenario_pricing_overrides",
  ...
  {
    "path": "#/$defs/d_2f5d441d7c3b7cd29f67/properties/settlement",
    "source": "https://finstack_quant.dev/schemas/instrument/1/equity/equity_option.schema.json#/$defs/EquityOption/properties/settlement",
    "default": "cash",
    "description": "Settlement type (physical or cash)",
    "ref": "#/$defs/SettlementType",
    "resolvedRef": "https://finstack_quant.dev/schemas/instrument/1/equity/equity_option.schema.json#/$defs/SettlementType"
  },
  {
    "path": "#/$defs/d_2f5d441d7c3b7cd29f67/properties/spot_id",
    "source": "https://finstack_quant.dev/schemas/instrument/1/equity/equity_option.schema.json#/$defs/EquityOption/properties/spot_id",
    "description": "Equity spot price identifier",
    "ref": "https://finstack_quant.dev/schemas/common/1/id.schema.json",
    "resolvedRef": "https://finstack_quant.dev/schemas/common/1/id.schema.json#"
  },
  {
    "path": "#/$defs/d_2f5d441d7c3b7cd29f67/properties/strike",
    "source": "https://finstack_quant.dev/schemas/instrument/1/equity/equity_option.schema.json#/$defs/EquityOption/properties/strike",
    "description": "Strike price",
    "format": "double"
  },
  {
    "path": "#/$defs/d_2f5d441d7c3b7cd29f67/properties/theta_day_basis",
    "source": "https://finstack_quant.dev/schemas/instrument/1/equity/equity_option.schema.json#/$defs/EquityOption/properties/theta_day_basis",
    ...
    "resolvedRef": "https://finstack_quant.dev/schemas/instrument/1/equity/equity_option.schema.json#/$defs/ThetaDayBasis"
  },
  {
    "path": "#/$defs/d_2f5d441d7c3b7cd29f67/properties/underlying_ticker",
    "source": "https://finstack_quant.dev/schemas/instrument/1/equity/equity_option.schema.json#/$defs/EquityOption/properties/underlying_ticker",
    "description": "Underlying equity ticker symbol"
  },
  {
    "path": "#/$defs/d_2f5d441d7c3b7cd29f67/properties/vol_surface_id",
    "source": "https://finstack_quant.dev/schemas/instrument/1/equity/equity_option.schema.json#/$defs/EquityOption/properties/vol_surface_id",
    "description": "Equity volatility surface ID",
    "ref": "https://finstack_quant.dev/schemas/common/1/id.schema.json",
    "resolvedRef": "https://finstack_quant.dev/schemas/common/1/id.schema.json#"
  },
  {
  ...
  {
    "path": "#/$defs/d_33b02706c5cbfe6ae8f8",
    "source": "https://finstack_quant.dev/schemas/instrument/1/equity/equity_option.schema.json#/$defs/OptionType",
    "description": "Option payoff direction used by analytical and numerical model engines."
  },
  {
    "path": "#/$defs/d_33b02706c5cbfe6ae8f8/oneOf/0",
    "source": "https://finstack_quant.dev/schemas/instrument/1/equity/equity_option.schema.json#/$defs/OptionType/oneOf/0",
    "const": "call",
    "description": "Call option."
  },
  {
    "path": "#/$defs/d_33b02706c5cbfe6ae8f8/oneOf/1",
    "source": "https://finstack_quant.dev/schemas/instrument/1/equity/equity_option.schema.json#/$defs/OptionType/oneOf/1",
    "const": "put",
    "description": "Put option."
  },
  {
    "path": "#/$defs/d_412dae1195797c4eb300",
    "source": "https://finstack_quant.dev/schemas/instrument/1/equity/equity_option.schema.json#/$defs/ExerciseStyle",
    "description": "Exercise schedule convention for option models."
  },
  {
    "path": "#/$defs/d_412dae1195797c4eb300/oneOf/0",
    "source": "https://finstack_quant.dev/schemas/instrument/1/equity/equity_option.schema.json#/$defs/ExerciseStyle/oneOf/0",
    "const": "european",
    "description": "Exercise only at expiry."
  },
  {
    "path": "#/$defs/d_412dae1195797c4eb300/oneOf/1",
    "source": "https://finstack_quant.dev/schemas/instrument/1/equity/equity_option.schema.json#/$defs/ExerciseStyle/oneOf/1",
    "const": "american",
    "description": "Exercise at any eligible time through expiry."
  },
  {
    "path": "#/$defs/d_412dae1195797c4eb300/oneOf/2",
    "source": "https://finstack_quant.dev/schemas/instrument/1/equity/equity_option.schema.json#/$defs/ExerciseStyle/oneOf/2",
    "const": "bermudan",
  ...
  {
    "path": "#/$defs/d_61ff31bdab5152167a53",
    "source": "https://finstack_quant.dev/schemas/instrument/1/equity/equity_option.schema.json#/$defs/EquityOptionExercise",
    "description": "Observed exercise or expiry state for an equity option.\n\nFrom `date` onward the option pricer uses this fixed lifecycle state rather\nthan re-running the live option model. Cash settlement fixes the intrinsic\npayoff from `spot`; physical settlement retains the marked delivery\nobligation until `settlement_date`."
  },
  {
    "path": "#/$defs/d_61ff31bdab5152167a53/properties/date",
    "source": "https://finstack_quant.dev/schemas/instrument/1/equity/equity_option.schema.json#/$defs/EquityOptionExercise/properties/date",
    "description": "Exercise date, or the expiry observation date for an unexercised option.",
    "ref": "https://finstack_quant.dev/schemas/common/1/date.schema.json",
    "resolvedRef": "https://finstack_quant.dev/schemas/common/1/date.schema.json#"
  },
  {
    "path": "#/$defs/d_61ff31bdab5152167a53/properties/exercised",
    "source": "https://finstack_quant.dev/schemas/instrument/1/equity/equity_option.schema.json#/$defs/EquityOptionExercise/properties/exercised",
    "description": "Whether the option was exercised or automatically assigned."
  },
  {
    "path": "#/$defs/d_61ff31bdab5152167a53/properties/settlement_date",
    "source": "https://finstack_quant.dev/schemas/instrument/1/equity/equity_option.schema.json#/$defs/EquityOptionExercise/properties/settlement_date",
    "description": "Contractual cash-payment or physical-delivery date.",
    "ref": "https://finstack_quant.dev/schemas/common/1/date.schema.json",
    "resolvedRef": "https://finstack_quant.dev/schemas/common/1/date.schema.json#"
  },
  {
    "path": "#/$defs/d_61ff31bdab5152167a53/properties/spot",
    "source": "https://finstack_quant.dev/schemas/instrument/1/equity/equity_option.schema.json#/$defs/EquityOptionExercise/properties/spot",
    "description": "Observed underlying level used to determine the fixed cash payoff.",
    "format": "double"
  },
  {
  ...
  {
    "path": "#/$defs/d_72fadc404aba1b1dd9e7",
    "source": "https://finstack_quant.dev/schemas/instrument/1/equity/equity_option.schema.json#/$defs/equity_option"
  },
  {
    "path": "#/$defs/d_72fadc404aba1b1dd9e7/properties/spec",
    "source": "https://finstack_quant.dev/schemas/instrument/1/equity/equity_option.schema.json#/$defs/equity_option/properties/spec",
    "ref": "#/$defs/EquityOption",
    "resolvedRef": "https://finstack_quant.dev/schemas/instrument/1/equity/equity_option.schema.json#/$defs/EquityOption"
  },
  {
    "path": "#/$defs/d_72fadc404aba1b1dd9e7/properties/type",
    "source": "https://finstack_quant.dev/schemas/instrument/1/equity/equity_option.schema.json#/$defs/equity_option/properties/type",
    "const": "equity_option"
  },
  {
  ...
  {
    "path": "#/$defs/d_d0e7891c1e0a70ca88ed",
    "source": "https://finstack_quant.dev/schemas/instrument/1/equity/equity_option.schema.json#/$defs/SettlementType",
    "description": "Settlement type for options"
  },
  {
    "path": "#/$defs/d_d0e7891c1e0a70ca88ed/oneOf/0",
    "source": "https://finstack_quant.dev/schemas/instrument/1/equity/equity_option.schema.json#/$defs/SettlementType/oneOf/0",
    "const": "physical",
    "description": "Physical delivery"
  },
  {
    "path": "#/$defs/d_d0e7891c1e0a70ca88ed/oneOf/1",
    "source": "https://finstack_quant.dev/schemas/instrument/1/equity/equity_option.schema.json#/$defs/SettlementType/oneOf/1",
    "const": "cash",
  ...
  {
    "path": "#/$defs/d_fd088e1a6a3e75435ae8",
    "source": "https://finstack_quant.dev/schemas/instrument/1/equity/equity_option.schema.json#/$defs/InstrumentSchema",
  ...
  },
  {
    ...
    "source": "https://finstack_quant.dev/schemas/instrument/1/equity/equity_option.schema.json#/properties/instrument",
    "ref": "#/$defs/equity_option",
    "resolvedRef": "https://finstack_quant.dev/schemas/instrument/1/equity/equity_option.schema.json#/$defs/equity_option"
  },
  {
    "path": "#/properties/schema",
    "source": "https://finstack_quant.dev/schemas/instrument/1/equity/equity_option.schema.json#/properties/schema",
    "ref": "#/$defs/InstrumentSchema",
    "resolvedRef": "https://finstack_quant.dev/schemas/instrument/1/equity/equity_option.schema.json#/$defs/InstrumentSchema"
  }
];
