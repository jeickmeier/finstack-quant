      ...
      >
        {(control) => (
          <textarea
            ...
            className="w-full rounded-sm border border-border bg-background p-2 font-mono text-xs focus-visible:outline-2 focus-visible:outline-ring"
          />
        )}
      </FieldFrame>
      <button
  ...
  return (
    ...
    >
      ...
      <ModelPicker
        ...
        disabled={loading}
      />
      {value.model && !(models[instrumentType] ?? []).includes(value.model) && (
        <p role="status">
