...
try {
  ...
  await writeFile(
    ...
    '<!doctype html><html lang="en"><head><meta charset="UTF-8"><title>Chart interactions</title><link rel="stylesheet" href="/app.css"></head><body class="finstack-surface"><div id="root"></div><script type="module" src="/main.tsx"></script></body></html>',
  );
  const modules = [];
  await build({
    root: consumer,
    configFile: false,
    logLevel: "error",
    resolve: { alias: { "@/hooks": path.join(consumer, "hooks") } },
    plugins: [
      {
