...
import { CalibrationPanel } from "../registry/blocks/pricing-workbench/calibration-panel";
import cases from "./calibration/cases.json";
const pending = vi.hoisted(() => ({ validate: vi.fn() }));
vi.mock("../registry/hooks/use-market-validator/use-market-validator", () => ({
  useMarketValidator: () => pending.validate,
}));
vi.mock("../registry/hooks/use-calibrate/use-calibrate", () => ({
...
vi.mock("../registry/components/calibration-form/calibration-form", () => ({
  CalibrationForm: ({ defaultJson, onValidated, onSubmit }: any) => {
    ...
    return (
      <>
        ...
        <button onClick={() => onValidated(defaultJson)}>Accept fixture</button>
      </>
    );
  },
}));
vi.mock("../registry/components/calibration-report/calibration-report", () => ({
  CalibrationReport: () => null,
}));
vi.mock(
  "../registry/components/calibration-fit-chart/calibration-fit-chart",
