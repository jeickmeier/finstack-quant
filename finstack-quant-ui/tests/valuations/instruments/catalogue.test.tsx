...
import { InstrumentSelector } from "@/components/finstack/valuations/components/instrument-form/instrument-selector";
...
vi.mock("../../../src/codec.mjs", async (importOriginal) => {
  const actual =
    await importOriginal<typeof import("../../../src/codec.mjs")>();
  return {
    ...actual,
