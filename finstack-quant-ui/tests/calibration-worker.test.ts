...
import { unwrap, errorValue } from "../registry/workers/finstack-contract";
import { calibrationOptions } from "../registry/hooks/use-calibrate/use-calibrate";
...
const cases = fixtures
  ...
  .map((f) => ({
    source: f.source,
    json: readFileSync(resolve(import.meta.dirname, "../..", f.source), "utf8"),
  }));
