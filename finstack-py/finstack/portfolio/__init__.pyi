...
class OptimizationParameters:
    ...
    def with_constraint(self, constraint: Constraint) -> OptimizationParameters: ...
    def with_weighting(self, weighting: WeightingScheme) -> OptimizationParameters: ...
    def with_missing_metric_policy(self, policy: MissingMetricPolicy) -> OptimizationParameters: ...
    def with_label(self, label: str) -> OptimizationParameters: ...
    @classmethod
    def from_json(cls, json_str: str) -> OptimizationParameters: ...
    def to_json(self) -> str: ...
    @property
