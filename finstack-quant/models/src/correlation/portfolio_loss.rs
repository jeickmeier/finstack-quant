...
impl PortfolioLossResult {
    ...
    /// Valuation-instrument tranche allocation may use percentage attachment
    /// points; that product-specific convention is intentionally not reused here.
    ///
    /// # Errors
    ///
...
fn allocation_error(message: impl Into<String>) -> Error {
