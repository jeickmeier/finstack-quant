...
//!
//! Given a calibrated [`CreditFactorModel`][crate::factor::credit::hierarchy::CreditFactorModel]
//! and observed issuer spreads at a point in time,
//! [`decompose_levels`][crate::factor::credit::decomposition::decompose_levels] peels off
//! the generic (PC) component and each hierarchy level in turn, producing a
//! [`LevelsAtDate`][crate::factor::credit::decomposition::LevelsAtDate] snapshot.
//!
//! [`decompose_period`][crate::factor::credit::decomposition::decompose_period] then
//! differences two [`LevelsAtDate`][crate::factor::credit::decomposition::LevelsAtDate]
//! snapshots into a
//! [`PeriodDecomposition`][crate::factor::credit::decomposition::PeriodDecomposition]
...
use crate::factor::credit::units::{decimal_to_bp, validate_decimal_spread};
...
pub enum DecompositionError {
    ...
    MissingTag {
        ...
        issuer_id: IssuerId,
        /// Canonical key (per [`crate::factor::credit::hierarchy::dimension_key`]) of the missing dimension.
        dimension: String,
    },
    ...
    ///
    /// Typical causes: a [`BucketWeighting::Dts`][crate::factor::credit::calibration::BucketWeighting::Dts]
