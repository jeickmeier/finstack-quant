...
pub trait RandomStream: Clone + Send + Sync {
    ...
    /// draws.
    ///
    /// The generic [`crate::monte_carlo::engine::McEngine`] rejects quasi-random streams:
    ...
    /// belongs in [`crate::monte_carlo::pricer::path_dependent::PathDependentPricer`],
...
pub mod state_keys {
    ...
    pub use crate::monte_carlo::indexed_spot_table::INDEXED_SPOT_INLINE;

    use crate::monte_carlo::indexed_spot_table::INDEXED_SPOT_TABLE;
...
pub trait StochasticProcess: Send + Sync {
    ...
    /// [`QeHeston`](crate::monte_carlo::discretization::QeHeston)) should return `true` from
    ...
    ///
    /// The generic [`crate::monte_carlo::engine::McEngine`] fills every factor slot with
    ...
    /// through [`crate::monte_carlo::engine_fractional::simulate_path_fractional`] (or a
    ...
    /// discrete dividends ([`crate::monte_carlo::process::gbm_dividends::GbmWithDividends`]).
    /// Pairing them
...
/// The generic [`crate::monte_carlo::engine::McEngine`] applies the caller-supplied
...
/// cashflows into the captured [`crate::monte_carlo::paths::PathPoint`] for that event.
///
/// # Examples
///
/// ```rust
/// use finstack_quant_core::currency::Currency;
/// use finstack_quant_core::money::Money;
/// use finstack_quant_models::monte_carlo::traits::{state_keys, PathState, Payoff};
///
/// #[derive(Clone)]
/// struct TerminalCall {
///     strike: f64,
...
pub trait Payoff: Send + Sync + Clone {
    ...
    ///
    /// The generic [`crate::monte_carlo::engine::McEngine`] still expects an explicit
