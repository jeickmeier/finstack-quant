...
impl MasterScale {
    ...
    pub fn sp_assumptions() -> finstack_quant_core::Result<Self> {
    ...
    pub fn moodys_assumptions() -> finstack_quant_core::Result<Self> {
    ...
    pub fn from_registry_id(id: &str) -> finstack_quant_core::Result<Self> {
        ...
        Self::new(grades).map_err(|err| {
            finstack_quant_core::Error::Validation(format!("invalid PD master scale '{id}': {err}"))
        })
    }
