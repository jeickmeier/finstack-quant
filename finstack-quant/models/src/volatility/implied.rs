...
use crate::closed_form::volatility::{
...
///
/// ```rust
/// use finstack_quant_models::closed_form::volatility::bachelier_call;
...
#[inline]
fn validate_positive(value: f64) -> finstack_quant_core::Result<()> {
...
#[inline]
fn validate_time(t: f64) -> finstack_quant_core::Result<()> {
...
#[inline]
fn validate_price(price: f64) -> finstack_quant_core::Result<()> {
