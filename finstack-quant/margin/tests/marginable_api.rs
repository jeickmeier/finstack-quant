...
use finstack_quant_margin::metrics::{
    InitialMarginMetric, TotalMarginMetric, VariationMarginMetric,
};
use finstack_quant_margin::{
    ImCalculator, Marginable, SimmCalculator, SimmSensitivities, SimmVersion,
};
...
impl Marginable for StandaloneMarginable {
    ...
    fn netting_set_id(&self) -> Option<finstack_quant_margin::NettingSetId> {
        None
    }
