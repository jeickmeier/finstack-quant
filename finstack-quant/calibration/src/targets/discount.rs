...
Global solve requires strictly increasing times.",
    ...
    pub(crate) fn solve(
        ...
        let raw_rates_quotes: Vec<crate::quotes::rates::RateQuote> = quotes.extract_quotes();
...
mod tests {
    ...
    fn discount_quote_time_uses_swap_payment_date_when_payment_delay_applies() {
        ...
        // Native Quote
        // Native Quote
        let quote = crate::quotes::rates::RateQuote::Swap {
            id: crate::quotes::ids::QuoteId::new("SWP-1Y"),
            index: finstack_quant_core::types::IndexId::new("USD-SOFR-OIS"),
            pillar: crate::quotes::ids::Pillar::Date(maturity), // 1Y
            rate: 0.02,
            spread_decimal: None,
        };
        ...
        let cal_id = "usny";
        let pay_date =
            finstack_quant_valuations::instruments::pricing::swap_legs::add_payment_delay(
                maturity,
                delay,
                Some(cal_id),
            )
    ...
    fn global_solve_discount_curve_sanity_check() {
        ...
        // RateQuote::Deposit
        let quote = crate::quotes::rates::RateQuote::Deposit {
            id: crate::quotes::ids::QuoteId::new("DEP-1Y"),
    ...
    fn test_residual_normalization_invariance() {
        ...
        let run_calibration = |notional: f64| -> DiscountCurve {
            ...
            for (days, rate) in [(30, 0.04), (90, 0.045), (180, 0.05), (365, 0.055)] {
                ...
                let quote = crate::quotes::rates::RateQuote::Deposit {
                    id: crate::quotes::ids::QuoteId::new(format!("DEP-{}D", days)),
                    index: finstack_quant_core::types::IndexId::new("USD-SOFR"),
                    pillar: crate::quotes::ids::Pillar::Date(maturity),
                    rate,
                };
    ...
    fn test_futures_initial_guess_applies_convexity_adjustment() {
        ...
        let make_futures_quote = |adj: f64| -> CalibrationQuote {
            let quote = crate::quotes::rates::RateQuote::Futures {
                id: crate::quotes::ids::QuoteId::new("FUT-3M"),
                contract:
                    finstack_quant_valuations::market::conventions::ids::IrFutureContractId::new(
                        "CME:SR3",
                    ),
                expiry: maturity,
    ...
    fn replay_recipe_preserves_supported_mixed_quote_shapes_losslessly() {
        ...
        let quotes = [
            RateQuote::Deposit {
                id: crate::quotes::ids::QuoteId::new("DEP"),
                index: index.clone(),
                pillar: crate::quotes::ids::Pillar::Date(date),
                rate: 0.043,
            },
            RateQuote::Fra {
                id: crate::quotes::ids::QuoteId::new("FRA"),
                index: index.clone(),
                start: crate::quotes::ids::Pillar::Tenor("3M".parse().expect("valid tenor")),
                end: crate::quotes::ids::Pillar::Date(date),
                rate: 0.041,
            },
            RateQuote::Futures {
                id: crate::quotes::ids::QuoteId::new("FUT"),
                contract:
                    finstack_quant_valuations::market::conventions::ids::IrFutureContractId::new(
                        "CME:SR3",
                    ),
            ...
            RateQuote::Swap {
                id: crate::quotes::ids::QuoteId::new("SWAP"),
                index,
                pillar: crate::quotes::ids::Pillar::Tenor("5Y".parse().expect("valid tenor")),
                rate: 0.039,
        ...
        assert!(matches!(
            ...
            RateCalibrationQuote::Fra {
                start: RateCalibrationPillar::Tenor(_),
                end: RateCalibrationPillar::Date(value),
                ..
            } if *value == date
        ));
        assert!(matches!(
            ...
            RateCalibrationQuote::Futures {
                ...
                ..
            } if (*value - 0.0001).abs() < f64::EPSILON
        ));
        assert!(matches!(
            &replay_quotes[3],
