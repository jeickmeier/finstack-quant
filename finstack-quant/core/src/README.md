# finstack-quant-core `src/` overview

Low-level building blocks for the Finstack Quant workspace:
...
implementation and integration tests under `finstack-quant/core/tests/` when behavior
spans modules.
...
- Integration tests: `finstack-quant/core/tests/`
