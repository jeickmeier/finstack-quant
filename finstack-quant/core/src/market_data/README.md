...
The `market_data` module in `finstack-quant-core` provides yield curves, credit
...
```rust
use finstack_quant_core::collections::HashMap;
use finstack_quant_core::market_data::context::{MarketContext, BumpSpec};
...
fn measure_shift(market_t0: MarketContext, market_t1: MarketContext) -> finstack_quant_core::Result<f64> {
...
`finstack-quant/core/tests/market_data/`.
