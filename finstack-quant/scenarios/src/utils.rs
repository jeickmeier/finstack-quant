...
use finstack_quant_core::dates::{BusinessDayConvention, Date, DayCount, HolidayCalendar, Tenor};
...
/// `finstack_quant_core::dates::Tenor::add_to_date`.
///
/// # Arguments
...
/// # Examples
/// ```
/// # use finstack_quant_scenarios::parse_tenor_to_years;
...
/// `finstack_quant_core::dates::Tenor::add_to_date`, which honours the
...
/// # Examples
/// ```
/// # use finstack_quant_scenarios::parse_period_to_days;
