...
`finstack-quant-scenarios` applies deterministic shocks and time rolls to market data,
...
- `finstack-quant-core` — market data and dates
- `finstack-quant-statements` — statement models
- `finstack-quant-valuations` — pricing-aware rolls and instrument shocks

Bindings: `finstack-quant-py`, `finstack-quant-wasm`.
...
```bash
cargo test -p finstack-quant-scenarios
```
