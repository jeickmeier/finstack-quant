...
#[test]
fn equity_vanna_and_volga_match_reference_fd() -> finstack_quant_core::Result<()> {
...
#[test]
fn fx_vanna_and_volga_match_reference_fd() -> finstack_quant_core::Result<()> {
    let as_of = date(2025, 1, 2);
    let expiry = date(2025, 7, 2);
...
#[test]
fn fx_volga_returns_zero_when_surface_vol_is_zero() -> finstack_quant_core::Result<()> {
    let as_of = date(2025, 1, 2);
    let expiry = date(2025, 7, 2);
