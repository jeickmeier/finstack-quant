...
impl BarrierParams {
    ...
    /// # Errors
    ///
    /// Returns a [`finstack_quant_core::Error::Validation`] when `df` is not a
...
/// # Errors
///
/// Returns a [`finstack_quant_core::Error::Validation`] when `spot`, `strike` or
