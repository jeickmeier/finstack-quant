...
use finstack_quant_monte_carlo::payoff::barrier::{BarrierOptionPayoff, BarrierType, OptionKind};
...
impl FxBarrierPayoff {
    ...
    pub fn new(
        ...
        let time_grid = finstack_quant_monte_carlo::time_grid::TimeGrid::uniform(
