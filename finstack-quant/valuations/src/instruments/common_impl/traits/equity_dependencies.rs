...
///
/// ```rust
/// use finstack_quant_valuations::instruments::{EquityDependencies, EquityInstrumentDeps};
///
/// struct EquityOption {
///     spot_id: String,
...
///
/// ```rust
/// use finstack_quant_valuations::instruments::EquityInstrumentDeps;
///
...
impl EquityInstrumentDepsBuilder {
    ...
    pub fn build(self) -> finstack_quant_core::Result<EquityInstrumentDeps> {
        Ok(self.deps)
    }
}
