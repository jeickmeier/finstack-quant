...
```rust
use finstack_quant_valuations::instruments::credit_derivatives::cds_tranche::{CDSTranche, CopulaSpec, RecoverySpec};
use finstack_quant_valuations::instruments::credit_derivatives::cds_tranche::pricer::{CDSTranchePricer, CDSTranchePricerConfig};
