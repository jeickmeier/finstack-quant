...
///
/// ```text
/// use finstack_quant_valuations::instruments::rates::irs::{InterestRateSwap, pricer};
/// use finstack_quant_core::market_data::context::MarketContext;
/// use finstack_quant_core::dates::Date;
/// # use time::Month;
///
...
///     .map_err(|e| finstack_quant_core::Error::Validation(format!("{}", e)))?;
///
...
mod tests {
    ...
    fn compounded_ois_seasoned_uses_fixings_and_projection() {
        use finstack_quant_core::dates::{BusinessDayConvention, DateExt, DayCount, Tenor};
