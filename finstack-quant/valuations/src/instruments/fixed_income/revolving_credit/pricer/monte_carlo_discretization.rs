...
impl RevolvingCreditDiscretization {
    ...
    pub fn new(correlation: Option<&[[f64; 3]; 3]>) -> finstack_quant_core::Result<Self> {
    ...
    #[cfg(test)]
    pub fn from_process(process: &RevolvingCreditProcess) -> finstack_quant_core::Result<Self> {
