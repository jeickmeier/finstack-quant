...
```rust
use finstack_quant_valuations::instruments::fixed_income::structured_credit::prelude::*;
...
```rust
use finstack_quant_valuations::instruments::fixed_income::structured_credit::pricing::stochastic::{
...
- `finstack_quant_core::dates` - Schedule generation, day counts
- `finstack_quant_core::money` - Currency-safe arithmetic
- `finstack_quant_valuations::metrics` - Metric registry and calculators
