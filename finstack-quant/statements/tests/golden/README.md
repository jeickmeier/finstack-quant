...
Reference fixtures that validate `finstack-quant-statements` output against external tools.

Tests use `finstack_quant_core::golden` (`GoldenSuite`, `ExpectedValue`, `GoldenAssert`, `load_suite_from_path`, `assert_abs`).
