...
impl DriftSchedule {
    ...
    /// value.
    pub fn new(times: Vec<f64>, cumulative_drift: Vec<f64>) -> finstack_quant_core::Result<Self> {
...
impl GbmProcess {
    ...
    pub fn with_params(r: f64, q: f64, sigma: f64) -> finstack_quant_core::Result<Self> {
