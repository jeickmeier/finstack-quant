...
- Parity impact: check `finstack-py/parity_contract.toml` and `finstack-py/tests/parity`

## Examples

- Python notebooks: `uv run python finstack-py/examples/notebooks/run_all_notebooks.py`
