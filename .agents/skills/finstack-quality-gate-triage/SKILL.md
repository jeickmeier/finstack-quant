---
name: finstack-quality-gate-triage
...
Use `finstack-quant-finance-review` first when the failure points to pricing/risk correctness. Use `finstack-binding-parity-reviewer` first when the failure is primarily cross-language API drift.
