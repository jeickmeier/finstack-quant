...
- `finstack-py/DOCS_STYLE.md`: Python documentation style and generated-doc expectations.
- `docs/REFERENCES.md`: canonical academic and market references for formulas and conventions.
- `finstack-py/parity_contract.toml`: binding parity source of truth.
...
- Python `.pyi` stubs under `finstack-py/finstack/`
- PyO3 docstrings and module `__doc__` assignments
- WASM TypeScript declarations and JS facades
- Example notebooks under `finstack-py/examples/notebooks/`
...
- Notebook docs: prefer `uv run python finstack-py/examples/notebooks/run_all_notebooks.py` when scope justifies it.
