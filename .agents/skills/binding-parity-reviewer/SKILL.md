...
Use `quant-finance-review` first when the main risk is pricing or risk correctness. Use `refactor` first when the change is purely internal and no public binding surface changes.
